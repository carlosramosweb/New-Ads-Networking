...
$getRevenue = $revenues->getRevenue();
		...
		<div class="row">
			<div class="col-12">
				<div class="card card-secondary">
                    ...
                    <div class="card-body">
                        <form method="post" action="?action=edit&id=<?php echo $getRevenue->id; ?>" style="margin:15px 0 0 0;">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    <select id="domain" name="domain" class="form-control form-select domain" required>
                                        ...
                                        <option value="<?php echo $row->id; ?>" <?php if ($getRevenue->domain==$row->id) { echo 'selected'; } ?>>
                                            <?php echo $row->domain; ?>
                                        </option>
                                            <?php } ?>
                                        <?php } ?>
                                ...
                                <div class="row form-group col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <input class="form-control" id="date_at" name="date_at" type="date" required value="<?php echo $getRevenue->date_at; ?>" />
                                    </div>
                                    <div class="form-group col-md-6 col-lg-6 col-xl-6">
                                        ...
                                        <select name="currency" class="form-control form-select currency" required>
                                            <option value="">Selecione</option>
                                            <option value="1" <?php if ($getRevenue->currency=='1') { echo 'selected'; } ?>>Real (R$)</option>
                                            <option value="2" <?php if ($getRevenue->currency=='2') { echo 'selected'; } ?>>Dolar ($)</option>
                                            <option value="3" <?php if ($getRevenue->currency=='3') { echo 'selected'; } ?>>Euro (€)</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-3 col-lg-3 col-xl-3">
                                    ...
                                    <input class="form-control" id="revenue" name="revenue" type="text" required value="<?php echo number_format($getRevenue->revenue, 2, ',', '.'); ?>"/>
                                </div>
                                <div class="form-group col-md-3 col-lg-3 col-xl-3">
                                    <label class="control-label requiredField" for="views">
                                        Page Views: <span class="asteriskField">*</span>
                                    </label>
                                    <input class="form-control" id="views" name="views" type="number" required value="<?php echo $getRevenue->views; ?>" />
                                </div>
                                <div class="form-group col-md-3 col-lg-3 col-xl-3">
                                    <label class="control-label requiredField" for="printing">
                                        Impressões: <span class="asteriskField">*</span>
                                    </label>
                                    <input class="form-control" id="printing" name="printing" type="number" required value="<?php echo $getRevenue->printing; ?>" />
                                </div>
                                <div class="form-group col-md-3 col-lg-3 col-xl-3">
                                    <label class="control-label requiredField" for="reading_at">
                                        Leitura: <span class="asteriskField">*</span>
                                    </label>
                                    <input class="form-control" id="reading_at" name="reading_at" type="number" required value="<?php echo $getRevenue->reading_at; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="id" name="id" value="<?php echo $getRevenue->id; ?>">
                                <div>
...
function getDomainRevenue() {  
    ...
    var id = $( "#id" ).val();
    $.post('ajax.php', 
        {action: 'getDomainRevenue', domain: domain, date_at: date_at, id: id}, 
        function(response){ 
