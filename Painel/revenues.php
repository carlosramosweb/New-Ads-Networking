...
if(isset($_GET['action'])) {
    if($_GET['action'] == 'delete') {
        if(isset($_GET['id'])) {
            ...
            $revenues->admin_id = trim($_GET['admin_id']);
            $revenues->date_at = trim($_GET['date_at']);
...
$getRevenues = $revenues->getRevenues();
?>
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card-header">
          <h3 class="card-title">Lista de Rendimentos</h3>

          <a class="btn btn-info btn-sm" href="new-revenue.php" style="float: right;">
            ...
            Novo Rendimento
                  ...
                  <th style="width: 100px;">Receita</th>
                  <th style="width: 120px;">Page Views</th>                  
                  <th style="width: 100px;">Impressão</th>
                  ...
                  <?php if(!empty($getRevenues)) { ?>
									<?php foreach($getRevenues as $row) { 
                    $domain = new Domain();
