...
$getDate = date("Y-m", strtotime($getPayment->date_at));
?>
			...
			<div class="col-12">
				<div class="card card-secondary">
                    ...
                    <div class="card-header">
                      <h3 class="card-title">Editar Pagamento</h3>
                    </div>

                    <div class="card-body">
                        <form method="post" action="?action=edit&id=<?php echo $getPayment->id; ?>" style="margin:15px 0 0 0;">
                            ...
                            <div class="row">
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input class="form-control" id="date_at" name="date_at" type="month" required value="<?php echo $getDate; ?>" />
                                </div>
                                <div class="form-group col-md-3 col-lg-3 col-xl-3">
                                    <label class="control-label requiredField" for="total_revenue">
                                        Receita Total:
                                    </label>
                                    <input class="form-control" id="total_revenue" name="total_revenue" type="text" required readonly="" value="<?php echo number_format($getPayment->total_revenue, 2, ',', '.'); ?>" />
                                </div>
                                <div class="form-group col-md-3 col-lg-3 col-xl-3">
                                    <label class="control-label requiredField" for="invalids">
                                       Inválidos:
                                    </label>
                                    <input class="form-control" id="invalids" name="invalids" type="text" required readonly="" value="<?php echo number_format($getPayment->invalids, 2, ',', '.'); ?>" />
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <select name="type" class="form-control form-select type" required>
                                        <option value="1" <?php if($getPayment->type=='1') { echo 'selected=""'; } ?>>
                                            Real (R$)
                                        </option>
                                        <option value="2" <?php if($getPayment->type=='2') { echo 'selected=""'; } ?>>
                                            Porcentagem (%)
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input class="form-control" id="rate" name="rate" type="text" required d value="<?php echo number_format($getPayment->rate, 2, ',', '.'); ?>"/>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input class="form-control" id="net_revenue" name="net_revenue" type="text" required readonly="" value="<?php echo number_format($getPayment->net_revenue, 2, ',', '.'); ?>"/>
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    <label class="control-label requiredField" for="quotation">
                                        Cotação do Dolar: <span class="asteriskField">*</span>
                                    </label>
                                    <input class="form-control" id="quotation" name="quotation" type="text" required value="<?php echo number_format($getPayment->quotation, 2, ',', '.'); ?>" />
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    <label class="control-label requiredField" for="expense">
                                       Despesas:
                                    </label>
                                    <input class="form-control" id="expense" name="expense" type="text" required readonly="" value="<?php echo number_format($getPayment->expense, 2, ',', '.'); ?>"/>
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    <label class="control-label requiredField" for="exchange_rate">
                                       Taxa de Câmbio: <span class="asteriskField">*</span>
                                    </label>
                                    <input class="form-control" id="exchange_rate" name="exchange_rate" type="text" value="<?php echo number_format($getPayment->exchange_rate, 2, ',', '.'); ?>" required />
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <select name="status" class="form-control form-select status" required>
                                        ...
                                        <option value="1" <?php if($getPayment->status=='1') { echo 'selected=""'; } ?>>
                                            Pago
                                        </option>
                                        <option value="0" <?php if($getPayment->status=='0') { echo 'selected=""'; } ?>>
                                            Pendente
                                        </option>
                                    </select>
                                </div>
                                <div class="form-group col-md-2 col-lg-2 col-xl-2">
                                    ...
                                    <input class="form-control" id="total_receivable" name="total_receivable" type="text" readonly="" value="<?php echo number_format($getPayment->total_receivable, 2, ',', '.'); ?>" />
                                </div>
                            </div>

                            <div class="form-group">
                                <input type="hidden" name="admin_id" value="<?php echo $user_logged_id; ?>">
                                <input type="hidden" name="id" value="<?php echo $getPayment->id; ?>">
...
$( "#date_at" ).change(function() {
    ...
    $.post('ajax.php', 
        {action: 'getPaymentMonthReport', month_year: date_at}, 
        function(response){ 
