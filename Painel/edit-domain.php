			...
			<div class="col-12">
				<div class="card card-secondary">
                    ...
                    <div class="card-header">
                      <h3 class="card-title">Editar Dominío</h3>
                    </div>

                    <div class="card-body">
                        <form method="post" action="?action=edit&id=<?php echo $getDomain->id; ?>" style="margin:15px 0 0 0;">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12 col-lg-12 col-xl-12">
                                    ...
                                    <input class="form-control" id="domain" name="domain" type="url" required placeholder="Ex: https://meusite.com.br" value="<?php echo $getDomain->domain; ?>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">                                
                                ...
                                <input type="hidden" name="id" value="<?php echo $getDomain->id; ?>">
                                <div>
